...
@section('content')
	<div class="content flex flex-col w-full gap-8 py-8 px-10 flex-1">
		<div class="flex gap-8 w-full items-center justify-center">
			<div class="w-2/3">
				<x-display>Daftar Pengguna</x-display>
				<x-breadcrumb>
					Admin &gt; <span class="text-black">Kelola Pengguna Pilastik</span>
				</x-breadcrumb>
			</div>
			<div class="w-1/3">
		...
		<div class="flex gap-8 w-full flex-1">
			<div class="w-1/2">
				<x-card class="h-full flex items-center justify-center">
					<h1 class="text-3xl text-gray-800 text-center">Tabel Pengguna</h1>
				</x-card>
			</div>
			<div class="w-1/2">
				<div class="flex flex-col w-full h-full gap-8">
					...
					<x-card class="flex flex-1 justify-center items-center">
						<h1 class="text-3xl text-gray-800 text-center">Form Pengisian</h1>
					</x-card>
				</div>
			</div>
		</div>
